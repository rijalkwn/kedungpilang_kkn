...
<head>
    ...
    <title>Desa Kedung | AKTA KELAHIRAN</title>
...
<body>
    ...
    <div class="container">
        <h6>DESKRIPSI</h6>
        <p>Akta Kelahiran adalah Bukti Sah mengenai Status dan Peristiwa Kelahiran Seseorang yang dikeluarkan oleh Dinas
            Kependudukan dan Catatan Sipil. Bayi yang dilaporkan kelahirannya akan terdaftar dalam Kartu Keluarga dan
            diberi Nomor Induk Kependudukan (NIK) sebagai Dasar untuk Memperoleh Pelayanan Masyarakat Lainnya. Manfaat
            Akta Kelahiran: </p>
        <ul>
        ...
        <ol>
            <li>Foto copy Akta Nikah (bagi orang tua yang sudah bercerai dengan menggunakan Akta Cerai) yang telah
                dilegalisir KUA *apabila tidak bisa memberikan Surat Akta Nikah atau Itsbat maka Anak Merupakan Anak Ibu
            </li>
            <li>Untuk anak yang tidak diketahui asal usulnya persyaratan pembuatan akta harus dilengkapi dengan Surat
                Keterangan dari Kepolisian (menjelaskan asal usul anak) dan dokter (menjelaskan perkiraan usia anak)
            </li>
            ...
            <li>Surat Keterangan Lahir dari Kepala Desa / Lurah, Dokter, Bidan, Rumah Sakit yang disahkan di desa /
                kelurahan</li>
