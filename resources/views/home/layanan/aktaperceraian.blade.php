...
@section('content')
    ...
    <div class="container">
        ...
        <ul>
            ...
            <li>Akta Perkawinan Asli</li>
            <li>oto Copy Kartu Keluarga (KK) dan KTP-el</li>
            <li>Foto Copy Akta Kelahiran</li>
            <li>Bagi WNI Keturunan yang sudah ganti nama membawa Surat Bukti Ganti Nama</li>
            <li>Bagi orang asing yang melakukan Perceraian, yang bersangkutan membawa dokumen imigrasi dan SKLD</li>
            <li>Surat pengantar dari panitera Pengadilan Negara</li>
            <li>Surat Kuasa bermateral cukup berlaku bag penduduk yang tidak mampu melakukan pelaporan sendiri karena faktor
                umur, sakit keras, cacat mental atau cacat fisik (Perpres No 25 Tahun 2008 Pasal 98 ayat (1), (2) dan (3))
            </li>
        </ul>
        <br>
        ...
        <ul>
            ...
            <li>Fc. KTP-el dan KK para pihak</li>
        ...
        <ul>
            ...
            <li>Kutipan (Asli) Akta Perceraian</li>
